...
class ChiefEditorAgent(Agent):
    ...
    def process(self, initial_idea: str) -> str:
        ...
        task = f"Сформулируй краткий, но вдохновляющий начальный вектор для сёнэн-сценария, основываясь на идее: '{initial_idea}'. Укажи главного героя, его цель и основную завязку, характерную для сёнэн-джамп. Вектор должен быть на русском языке. Ограничься 500 символами."
